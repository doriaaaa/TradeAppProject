...
commentRouter.post("/api/comment/createComment", auth, async (req, res) => {
  ...
  try {
    ...
    console.log(
      `Current thread_id: ${thread_id}, Total Comments: ${totalComments}`
    );
    totalComments++;
...
// show all comments
commentRouter.get(
  "/api/comment/showAllComments/thread/:threadId",
  async (req, res) => {
    try {
      const commentsList = await Thread.findOne({
...
commentRouter.delete(
  "/api/comment/deleteComment/thread/:threadId/commentId/:commentId",
  async (req, res) => {
...
// user edit comment
commentRouter.put(
  "/api/comment/editComment/thread/:threadId/commentId/:commentId",
  auth,
  async (req, res) => {
    try {
